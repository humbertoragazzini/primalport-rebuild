      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mx-auto text-white">
          <div className="col-span-1">
            <div className="border-1 p-6 rounded-2xl flex justify-center items-center flex-col bg-slate-700 border-[rgba(255,255,255,0.1)]  overflow-hidden shadow-[0_0_25px_6px_rgba(150,150,150,0.2)]">
